...
export function HomeDashboard() {
  ...
  const actions = [
    ...
    hasPermission("ACESSOS_VISUALIZAR")
      ...
      : null,
    hasPermission("DEPARTAMENTO_VISUALIZAR")
      ? { href: "/painel/departamentos", title: "Departamentos e EBD", text: "Participantes, agenda, chamada e fechamento", icon: GraduationCap }
      : null,
    hasPermission("SECRETARIA_VISUALIZAR")
      ? { href: "/painel/secretaria", title: "Secretaria Eclesiástica", text: "Movimentações, batismos, consagrações e documentos", icon: BookCopy }
      : null
